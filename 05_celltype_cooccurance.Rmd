...
We can use spicyR to test if there is a change in the relative closeness of different celltypes (e.g. myeloid and epithelia) across different conditions.
...
We can plot the 'L-function' between these groups per condition. There is an L value for each sample, which represents the 'closeness' of the celltype pair in that sample. Higher values indicates co-localisation. 
